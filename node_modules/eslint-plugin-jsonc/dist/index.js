...
exports.getStaticJSONValue = exports.traverseNodes = exports.parseJSON = exports.parseForESLint = exports.processors = exports.rules = exports.configs = void 0;
const rules_1 = require("./utils/rules");
const processors_1 = __importDefault(require("./processors"));
exports.processors = processors_1.default;
...
function parseJSON(code, options) {
    ...
    return jsonc_eslint_parser_1.parseForESLint(code, parserOptions).ast;
}
